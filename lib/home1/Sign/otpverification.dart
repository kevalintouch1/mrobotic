...
import 'package:mrobotic/home1/Sign/signupdone.dart';
import 'package:mrobotic/home1/commonWidget.dart';
import 'package:shared_preferences/shared_preferences.dart';

class otpverification extends StatefulWidget {
  const otpverification({super.key, required autoid});
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                if (resendsmsotp['status'] == 1) {
                                  snackbar.ToastMsg(resendsmsotp['message'], 2,
                                      'green', context);
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                if (resdata['status'] == 1) {
                                  snackbar.ToastMsg(
                                      resdata['message'], 10, 'green', context);
                                } else if (resdata['status'] == 2) {
                                  snackbar.ToastMsg(
                                      resdata['message'], 10, 'red', context);
